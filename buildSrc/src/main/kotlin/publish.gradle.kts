    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/frankmarazita/mdcontacts/")
                ...
                developers {
                    developer {
                        id.set("frankmarazita")
                        name.set("frankmarazita")
                    }
                }
                scm {
                    connection.set("scm:git:git://github.com/frankmarazita/mdcontacts.git")
                    developerConnection.set("scm:git:ssh://github.com/frankmarazita/mdcontacts.git")
                    url.set("https://github.com/frankmarazita/mdcontacts/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/frankmarazita/mdcontacts/issues")
                }
            }
        }
    }
